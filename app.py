...
#             bigboxes = flipkart_html.findAll("div" , {"class" :"cPHDOP col-12-12"}) # find all div with that class jisme  product he 
#             del bigboxes[0:3]
#             box = bigboxes[0]
#             productLink = "https://www.flipkart.com" +  box[1].div.div.div.a['href']
#             prodRes = requests.get(productLink)
#             prodRes.encoding='utf-8'
#             prod_html = bs(prodRes.text, "html.parser")
#             print(prod_html)
